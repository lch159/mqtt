...
public class SensorsPlugin implements EventChannel.StreamHandler {
    ...
    private static final String ROTATION_VECTOR_CHANNER_NAME = "plugins.flutter.io/sensors/rotation";
    ...
    public static void registerWith(Registrar registrar) {
        ...
        final EventChannel rotationChannel =
                new EventChannel(registrar.messenger(), ROTATION_VECTOR_CHANNER_NAME);
        rotationChannel.setStreamHandler(
                new SensorsPlugin(registrar.context(), Sensor.TYPE_ROTATION_VECTOR));
